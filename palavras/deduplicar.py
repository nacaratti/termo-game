"""
Remove duplicatas de normalização dos arquivos solucoes.txt e validas.txt.
Para cada grupo de palavras que normalizam para a mesma forma (ex: ACABA/ACABÁ/ÁCABA),
mantém apenas a mais frequente segundo wordfreq. Em caso de empate, prefere a
forma sem acento (se existir) ou a primeira em ordem alfabética.
"""
...
def score(word):
    """Frequência no corpus pt. Desempate: prefere forma sem acento."""
...
for fname in ['solucoes.txt', 'validas.txt']:
    path = PALAVRAS / fname
